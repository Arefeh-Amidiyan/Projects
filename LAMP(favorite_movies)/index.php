...
function retrieve_recent_uploads($db, $count)
{
	...
	echo "نمایش $count رکورد اخیر از دیتابیس<br>";
...
if (isset($_SESSION['username']))
{
	...
	echo " JPG, JPEG, GIF, PNG:فایل های آپلود عکس باید با این فرمت ها باشند <br>&nbsp;<br>";

    echo "<button onclick='location.href=`insert.php`'>ثبت فیلم</button>";
    echo '<br>';
    echo '<br>';
    echo '<br>';
...
if ($storage_option == "hd")
{
	...
	foreach ($images as $image)
	{
        ...
        echo "<br>";
        echo 'نام فیلم: '.$image["name"];
        echo "<br>";
        echo 'نام کارگردان : '.$image["writer"];
        echo "<br>";
        echo 'سال تولید : '.$image["age"];
        echo "<br>";
        echo 'زمان ثبت فیلم: '.$image["timeline"];
        echo "<br>";
        if (isset($_SESSION['username'])){
		?>
